...
if __name__ == '__main__':
    ...
    services["comfy"] = Service("comfy", '. /tools/python_3.12_venv/bin/activate; python3.12 /tools/ComfyUI/main.py', 'RUNNING goto http://127.0.0.1:8188', 'To see the GUI go to:')
