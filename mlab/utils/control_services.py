...
if __name__ == '__main__':
    ...
    services["llama.cpp"] = Service("llama.cpp", '/tools/llama.cpp/build/bin/llama-server --models-dir /models/llama.cpp/ --no-models-autoload --jinja --host 127.0.0.1 --port 8080 -ngl 999 --models-preset /tools/llama.cpp/llama_models.ini', 'RUNNING goto http://127.0.0.1:8080', 'listening on', 8080)
